...
dados <- read.csv(file = "classificado_TODAS_AREAS.csv",sep = ",")
N <- dim(dados)[1]
...
treinamentoX <- x[1:243,2:4]#60% da amostra
treinamentoY <- x[1:243,5]#60% da amostra

primeiraClassificacaoX <- x[244:324,2:4]
primeiraClassificacaoY <- x[244:324,5]

segundaClassificacaoX <- x[325:405,2:4]
segundaClassificacaoY <- x[325:405,5]
